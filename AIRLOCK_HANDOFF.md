# AirLock — Project Handoff

A snapshot of where **AirLock** stands as of June 24, 2026. Drop this into your
...
- **Live URL:** https://airlock-pdf-editor.mozilla614.workers.dev
- **Repo:** https://github.com/mrod541/airlock-pdf-editor (branch `main`)
...
- **WASM core:** the Emscripten loader's wasm-fetch gate is patched to seed from
  an inlined global `self.__AIRLOCK_CORE_WASM__`; the patched loader (core bytes
...
Authoritative working copy: `C:\Users\Maurice\dev\airlock-clean` (clean git clone).
